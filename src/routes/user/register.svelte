			...
			<div>
				<form class="space-y-3">
					<div class="grid">
						...
						<input id="username" class="border-2 border-gray-300" type="text"/>
					</div>
					
					<div class="grid">
						<label class="text-sm text-gray-500" for="email">Email</label>
						<input id="email" class="border-2 border-gray-300" type="email"/>
					</div>
					<div class="grid">
						<label class="text-sm text-gray-500" for="pw">Password</label>
						<input id="pw" class="border-2 border-gray-300" type="password"/>
					</div>
					<div class="grid">
						<label class="text-sm text-gray-500" for="cpw">Confirm Password</label>
						<input id="cpw" class="border-2 border-gray-300" type="password"/>
					</div>
					<br/>
					<div class="bg-red-400 flex justify-center p-3 rounded-2xl text-white font-semibold">
						<button class="text-sm" type="sumbit">
							Get Started
						</button>
					</div>
				</form>
